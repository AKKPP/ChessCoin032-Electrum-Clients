...
$ adb shell monkey -p org.electrum.chesscoin 1
```
...
```
adb logcat | grep -F "`adb shell ps | grep org.electrum.chesscoin | cut -c14-19`"
```
...
```
$ adb shell
$ run-as org.electrum.chesscoin ls /data/data/org.electrum.chesscoin/files/data
$ run-as org.electrum.chesscoin cp /data/data/org.electrum.chesscoin/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
